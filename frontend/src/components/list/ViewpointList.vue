  ...
  <div class="list-wrapper" ref="TableHeadWrapper">
    ...
    <div class="table list-table-head" :class="{tableHeadTop:scrolled}">
      <div class="table-tr">
        ...
        <div class="table-th td-hot sorting sorting_asc" @click="sorting = hot">热度</div>
        <div class="table-th td-emotion">情绪</div>
        <div class="table-th td-sensitive sorting sorting_asc" @click="sorting = 'secu'">敏感</div>
...
export default {
  ...
  computed: {
    dispValues: function () {
      ...
      // debugger
      if (this.sorting) {
        return _.orderBy(xs, this.sorting, 'desc');
      } else {
        return xs;
      }
    },
