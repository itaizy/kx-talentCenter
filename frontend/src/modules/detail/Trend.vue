<template>
  <div class="row main-row" v-title data-title="Ring 事件趋势">
    <div class="col-md-12">
      <div class="r-panel hotnews-panel">
        ...
        <div class="panel-event">
          ...
          <Echarts theme="ring" :option="trend_option" :loading="loading.trend" :loadingOpts="{ text: '加载中...' }" className="chart"></Echarts>
        </div>
      </div>
    </div>
    <!-- <div class="col-md-4">
